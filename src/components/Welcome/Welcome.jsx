...
const Welcome = () => (
  <WelcomeBg>
    <picture>
      <source media="(max-width: 375px)" srcSet={`${StartImgMob1x} 1x, ${StartImgMob2x} 2x`} />
      <source media="(min-width: 768px)" srcSet={`${StartImgTab1x} 1x, ${StartImgTab2x} 2x`} />
      <source media="(min-width: 1440px)" srcSet={`${StartImgDesk1x} 1x, ${StartImgDesk2x} 2x`} />
      <img
        src={StartImgMob1x}
    ...
    <LogoWrap>
      <span><Lightning width={15} height={20} fillColor="#fff" /></span>
      <h1>Task Pro</h1>
    </LogoWrap>
